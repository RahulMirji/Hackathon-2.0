  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500">
      ...
      <div className="relative flex w-full max-w-5xl h-[600px] mx-4">
        ...
        <div className="hidden md:flex w-[45%] bg-gradient-to-br from-indigo-600 to-purple-600 rounded-l-3xl shadow-2xl items-center justify-center p-12 relative overflow-hidden">
          {/* Decorative circles */}
          ...
          <div className="relative z-10 text-center text-white">
            ...
            <p className="text-white/90 mb-8 text-lg">
              Join us today! Sign up to start your journey with us.
            </p>
        ...
        {/* Right side - Login form with angled edge */}
        <div className="relative w-full md:w-[55%] bg-white rounded-r-3xl md:rounded-r-3xl md:rounded-l-none rounded-3xl shadow-2xl p-8 md:p-12 flex items-center justify-center overflow-hidden">
          {/* Angled edge effect */}
