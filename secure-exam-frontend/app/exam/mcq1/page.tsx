...
export default function MCQ1Page() {
  ...
  const handleNext = () => {
    if (currentQuestion < mcq1Questions.length - 1) {
  ...
  const progress = ((currentQuestion + 1) / mcq1Questions.length) * 100
  const question = mcq1Questions[currentQuestion]
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-xl">MCQ 1 - General & Technical</h1>
                <p className="text-sm text-muted-foreground">Question {currentQuestion + 1} of {mcq1Questions.length}</p>
              </div>
            </div>
        ...
        <Card className="p-8">
          <div className="space-y-6">
            ...
            <div className="flex justify-between pt-6">
              ...
              {currentQuestion === mcq1Questions.length - 1 ? (
                <Button
