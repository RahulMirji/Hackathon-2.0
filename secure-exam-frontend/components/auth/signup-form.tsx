...
import { signInWithPopup, GoogleAuthProvider, GithubAuthProvider, createUserWithEmailAndPassword, updateProfile } from 'firebase/auth';
...
export function SignupForm() {
  ...
  const handleGithubSignUp = async () => {
    ...
    try {
      ...
      let errorMessage = err.message || 'Failed to sign up with GitHub';
      ...
      <form onSubmit={handleEmailSignUp} className="space-y-4 mb-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-12 pr-12 py-3.5 bg-gray-100 rounded-full text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 transition-all ${
              showPasswordMatch
                ? passwordsMatch
        ...
        {showPasswordMatch && (
          <div className={`text-sm text-center ${passwordsMatch ? 'text-green-600' : 'text-red-600'}`}>
